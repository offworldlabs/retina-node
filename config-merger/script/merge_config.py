...
def generate_env_file(config, output_dir):
    ...
    with open(temp_path, 'w') as f:
        ...
        # Location variables for readsb
        f.write("# readsb location\n")
        f.write(f"READSB_LAT={lat}\n")
        f.write(f"READSB_LON={lon}\n")
        f.write(f"READSB_ALT={alt}\n\n")

        # Location variables for tar1090 web UI
        f.write("# tar1090 location\n")
        f.write(f"LAT={lat}\n")
        f.write(f"LONG={lon}\n")
        f.write(f"TAR1090_DEFAULTCENTERLAT={lat}\n")
        f.write(f"TAR1090_DEFAULTCENTERLON={lon}\n\n")

        # Location variables for tar1090 proxy (adsb.lol fallback)
        f.write("# tar1090 proxy\n")
